...
class GroupControllerIT extends BaseIntegration {
        ...
        void create() {
                ...
                GroupDtoOut response = webTestClient.post().uri(PATH)
                                ...
                                .isCreated()
                                .expectHeader().contentType(MediaType.APPLICATION_JSON).expectBody(GroupDtoOut.class)
                                .returnResult()
                                .getResponseBody();
        ...
        void findAll() {
                ...
                assertThat(response).usingRecursiveComparison()
                                ...
                                .isEqualTo(List.of(adminGroupDtoOut(null), userGroupDtoOut(null)));
        }
        ...
        class Security {
                ...
                void create_withUserRole_returnsForbidden() {
                        webTestClient.post().uri(PATH)
                                        ...
                                        .contentType(MediaType.APPLICATION_JSON).bodyValue(adminGroupDtoIn()).exchange()
                                        .expectStatus()
                                        .isForbidden();
                }
