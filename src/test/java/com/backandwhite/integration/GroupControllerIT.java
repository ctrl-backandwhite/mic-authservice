...
class GroupControllerIT extends BaseIntegration {
    ...
    void create() {
        ...
        GroupDtoOut response = webTestClient
                .post()
                .uri(PATH)
        ...
        assertThat(response)
                ...
                .isEqualTo(adminGroupDtoOut(null));
    }
    ...
    void findAll() {
        ...
        repository.saveAll(List.of(
                adminGroupEntity().withId(null).withRoles(List.of(adminRole)),
                userGroupEntity().withId(null).withRoles(List.of(userRole))));

        List<GroupDtoOut> response = webTestClient
                .get()
                .uri(PATH)
                .header(HttpHeaders.AUTHORIZATION, getToken(List.of(ADMIN_UNIQUE_NAME)))
                .exchange()
        ...
        assertThat(response)
                ...
                .ignoringFields("id", "roles")
                .isEqualTo(List.of(
                        adminGroupDtoOut(null),
                        userGroupDtoOut(null)));
    }

    @Test
    void getById() {
        RoleEntity adminRole = roleRepository.save(adminRoleEntity().withId(null));
        GroupEntity saved = repository.save(adminGroupEntity().withId(null)
        ...
        assertThat(response)
                ...
                .isEqualTo(adminGroupDtoOut(saved.getId()));
    }
    ...
    void update() {
        ...
        assertThat(response)
                .usingRecursiveComparison()
                .ignoringFields("roles")
                .isEqualTo(userGroupDtoOut(saved.getId()));
    }
