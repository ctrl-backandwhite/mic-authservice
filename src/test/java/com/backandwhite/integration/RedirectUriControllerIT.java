        ...
        void findAll() {
                ...
                assertThat(response).usingRecursiveComparison()
                                .ignoringFieldsMatchingRegexes(".*createdAt", ".*updatedAt", ".*createdBy",
                                                ".*updatedBy")
                                .ignoringFields("id")
                                .isEqualTo(List.of(redirectUriDtoOut(null), otherRedirectUriDtoOut(null)));
        }
        ...
        class Security {
                ...
                void create_withUserRole_returnsForbidden() {
                        webTestClient.post().uri(PATH)
                                        ...
                                        .contentType(MediaType.APPLICATION_JSON).bodyValue(redirectUriDtoIn())
