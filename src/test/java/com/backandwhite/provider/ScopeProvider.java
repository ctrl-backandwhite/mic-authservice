...
public final class ScopeProvider {
    ...
    public static Scope readScope() {
        return Scope.builder().id(READ_ID).name(READ_NAME).uniqueName(READ_UNIQUE_NAME).description(READ_DESCRIPTION)
                .enabled(READ_ENABLED).createdAt(AuditProvider.CREATED_AT).updatedAt(AuditProvider.UPDATED_AT)
                .createdBy(AuditProvider.CREATED_BY).updatedBy(AuditProvider.UPDATED_BY).build();
    }

    public static Scope writeScope() {
        return Scope.builder().id(WRITE_ID).name(WRITE_NAME).uniqueName(WRITE_UNIQUE_NAME)
                .description(WRITE_DESCRIPTION).enabled(WRITE_ENABLED).createdAt(AuditProvider.CREATED_AT)
    ...
    public static ScopeEntity readScopeEntity() {
        return ScopeEntity.builder().id(READ_ID).name(READ_NAME).uniqueName(READ_UNIQUE_NAME)
                .description(READ_DESCRIPTION).enabled(READ_ENABLED).createdAt(AuditProvider.CREATED_AT)
                .updatedAt(AuditProvider.UPDATED_AT).createdBy(AuditProvider.CREATED_BY)
                .updatedBy(AuditProvider.UPDATED_BY).build();
    }

    public static ScopeEntity writeScopeEntity() {
        return ScopeEntity.builder().id(WRITE_ID).name(WRITE_NAME).uniqueName(WRITE_UNIQUE_NAME)
                .description(WRITE_DESCRIPTION).enabled(WRITE_ENABLED).createdAt(AuditProvider.CREATED_AT)
                .updatedAt(AuditProvider.UPDATED_AT).createdBy(AuditProvider.CREATED_BY)
                .updatedBy(AuditProvider.UPDATED_BY).build();
    }
    ...
    public static ScopeDtoIn readScopeDtoIn() {
        return ScopeDtoIn.builder().name(READ_NAME).uniqueName(READ_UNIQUE_NAME).description(READ_DESCRIPTION)
                .enabled(READ_ENABLED).build();
    }

    public static ScopeDtoIn writeScopeDtoIn() {
        return ScopeDtoIn.builder().name(WRITE_NAME).uniqueName(WRITE_UNIQUE_NAME).description(WRITE_DESCRIPTION)
                .enabled(WRITE_ENABLED).build();
    }

    public static ScopeDtoOut readScopeDtoOut(Long id) {
        return ScopeDtoOut.builder().id(id).name(READ_NAME).uniqueName(READ_UNIQUE_NAME).description(READ_DESCRIPTION)
                .enabled(READ_ENABLED).createdAt(AuditProvider.CREATED_AT).updatedAt(AuditProvider.UPDATED_AT)
                .createdBy(AuditProvider.CREATED_BY).updatedBy(AuditProvider.UPDATED_BY).build();
    }

    public static ScopeDtoOut writeScopeDtoOut(Long id) {
        return ScopeDtoOut.builder().id(id).name(WRITE_NAME).uniqueName(WRITE_UNIQUE_NAME)
                .description(WRITE_DESCRIPTION).enabled(WRITE_ENABLED).createdAt(AuditProvider.CREATED_AT)
                .updatedAt(AuditProvider.UPDATED_AT).createdBy(AuditProvider.CREATED_BY)
                .updatedBy(AuditProvider.UPDATED_BY).build();
    }
    ...
    public static Scope openidScope() {
        return Scope.builder().id(OPENID_ID).name(OPENID_NAME).uniqueName(OPENID_UNIQUE_NAME)
                .description(OPENID_DESCRIPTION).enabled(OPENID_ENABLED).createdAt(AuditProvider.CREATED_AT)
                .updatedAt(AuditProvider.UPDATED_AT).createdBy(AuditProvider.CREATED_BY)
                .updatedBy(AuditProvider.UPDATED_BY).build();
    }

    public static Scope profileScope() {
        return Scope.builder().id(PROFILE_ID).name(PROFILE_NAME).uniqueName(PROFILE_UNIQUE_NAME)
                .description(PROFILE_DESCRIPTION).enabled(PROFILE_ENABLED).createdAt(AuditProvider.CREATED_AT)
                .updatedAt(AuditProvider.UPDATED_AT).createdBy(AuditProvider.CREATED_BY)
                .updatedBy(AuditProvider.UPDATED_BY).build();
    }

    public static ScopeEntity openidScopeEntity() {
        return ScopeEntity.builder().id(OPENID_ID).name(OPENID_NAME).uniqueName(OPENID_UNIQUE_NAME)
                .description(OPENID_DESCRIPTION).enabled(OPENID_ENABLED).createdAt(AuditProvider.CREATED_AT)
                .updatedAt(AuditProvider.UPDATED_AT).createdBy(AuditProvider.CREATED_BY)
                .updatedBy(AuditProvider.UPDATED_BY).build();
    }
    ...
    public static ScopeEntity profileScopeEntity() {
        return ScopeEntity.builder().id(PROFILE_ID).name(PROFILE_NAME).uniqueName(PROFILE_UNIQUE_NAME)
                .description(PROFILE_DESCRIPTION).enabled(PROFILE_ENABLED).createdAt(AuditProvider.CREATED_AT)
                .updatedAt(AuditProvider.UPDATED_AT).createdBy(AuditProvider.CREATED_BY)
                .updatedBy(AuditProvider.UPDATED_BY).build();
    }
    ...
    public static ScopeDtoOut openidScopeDtoOut(Long id) {
        return ScopeDtoOut.builder().id(id).name(OPENID_NAME).uniqueName(OPENID_UNIQUE_NAME)
                .description(OPENID_DESCRIPTION).enabled(OPENID_ENABLED).createdAt(AuditProvider.CREATED_AT)
                .updatedAt(AuditProvider.UPDATED_AT).createdBy(AuditProvider.CREATED_BY)
                .updatedBy(AuditProvider.UPDATED_BY).build();
    }
    ...
    public static ScopeDtoOut profileScopeDtoOut(Long id) {
        return ScopeDtoOut.builder().id(id).name(PROFILE_NAME).uniqueName(PROFILE_UNIQUE_NAME)
                .description(PROFILE_DESCRIPTION).enabled(PROFILE_ENABLED).createdAt(AuditProvider.CREATED_AT)
                .updatedAt(AuditProvider.UPDATED_AT).createdBy(AuditProvider.CREATED_BY)
                .updatedBy(AuditProvider.UPDATED_BY).build();
    }
