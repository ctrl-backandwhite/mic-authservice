...
public class PermissionDtoOut {
    ...
    @Schema(description = "Nombre del permiso", example = "Crear usuarios", minLength = 3, maxLength = 100)
    private String name;

    @Schema(description = "Nombre único del permiso", example = "PERM_CREATE_USER", minLength = 3, maxLength = 100)
    private String uniqueName;

    @Schema(description = "Descripción detallada del permiso", example = "Permite crear nuevos usuarios en el sistema", maxLength = 500)
